sudo apt-get update && sudo apt-get install -y \
  autoconf automake build-essential libtool pkg-config texi2html yasm cmake curl git wget gperf \
  ninja-build cargo cargo-c nasm meson rsync xxd clang ladspa-sdk libgmp-dev \
